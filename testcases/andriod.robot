...
${PLATFORM_VERSION}        10.0  # Change to match your iOS version
${DEVICE_NAME}             is_it_matter  # Change to match your simulator device
${APP_PATH}                /Users/powereskitikonrat/appium-typescript/app/android/ColorNote.apk
